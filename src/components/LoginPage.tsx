        ...
        <div className="bg-white py-8 px-4 shadow-sm border border-[#E6E0D0] sm:rounded-2xl sm:px-10">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  className="h-4 w-4 text-[#4A3728] focus:ring-[#4A3728] border-gray-300 rounded"
                />
              ...
              <div className="text-sm">
                <a href="#" className="font-medium text-[#4A3728] hover:text-[#3A2B20]">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              ...
              >
                {t('auth.login.createAccount') || 'Create new account'}
              </Link>
            </div>
          </div>
        </div>
